...
\textbf{Publikację naukową} można zdefiniować w różny sposób w
zależności od celu w jakim została stworzona. Najogólniej publikacją
naukową określa się doniesienie o uzyskanych wynikach badań lub opis
istniejącego stanu wiedzy z określonego obszaru nauki. Artykuły naukowe
zamieszczane są w czasopismach, które publikują je w formie papierowej
lub najczęściej elektronicznej przez wydawnictwa naukowe. Ocena wpływu
danych czasopism odbywa się poprzez analizę bibliometryczną cytowań,
gdzie liczba cytowań artykułów w czasopiśmie stanowi miarę popularności
i wpływu czasopisma. Większość wydawnictw publikujących prace naukowe
wykorzystuje własne strony internetowe do przyjmowania, recenzowania
oraz udostępniania publikowanych prac w trybie on-line.
...
przeglądu bibliograficznego literatury naukowej metodami opartymi o
narzędzia data science. Hipotezy badawcza projektu zakłada, że metody
data science przyspieszają i zwiększając efektywność przeprowadzenia
przeglądu bibliograficznego w porównaniu z tradycyjnymi metodami jego
wykonania.
...
\tightlist
\item
  \textbf{Artykuł naukowy} jest to recenzowany artykuł opublikowany w
  czasopiśmie naukowym albo w recenzowanych materiałach z
...
\tightlist
\item
  \textbf{Monografia naukowa} jest to recenzowana publikacja książkowa:
\end{enumerate}
...
artykułów ciągle ma tendencje wzrostową (rys. \ref{pub_rocznie})
...
tys. czasopism, a ciągu ostatnich 10 lat liczba ich wzrosła o 29\% (rys.
\ref{liczba_czasopism}) (\protect\hyperlink{ref-curcic2023}{Curcic,
2023}).
...
\hypertarget{charakterystyka-wybranych-baz-indeksujux105cych}{%
\subsubsection{Charakterystyka wybranych baz
indeksujących}\label{charakterystyka-wybranych-baz-indeksujux105cych}}
...
\hypertarget{jux119zyk-python-python.org}{%
\subsubsection{\texorpdfstring{Język Python
\href{https://www.python.org}{python.org}}{Język Python python.org}}\label{jux119zyk-python-python.org}}
...
\hypertarget{jux119zyk-r-r-project.org}{%
\subsubsection{\texorpdfstring{Język R
\href{https://www.r-project.org}{r-project.org}}{Język R r-project.org}}\label{jux119zyk-r-r-project.org}}
...
\includegraphics{Rysunki/figures/webshot_2-1.png}
...
jest wyszczególniony poprzez plik robot.txt (rys. \ref{GS_robot}).

\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{Rysunki/robot.png}
\caption{Wyszczególnienie zasad dostępu do zasobów GS \label{GS_robot}}
\end{figure}
...
\tightlist
\item
  zestawienia obszarów dziedzin badawczych: Allow:
...
\hypertarget{wskaux17aniki-biblometryczne-dla-wybranych-naukowcuxf3w}{%
\subsubsection{Wskaźniki biblometryczne dla wybranych
naukowców}\label{wskaux17aniki-biblometryczne-dla-wybranych-naukowcuxf3w}}
...
\hypertarget{zestawienie-iloux15bci-opublikowanych-artykuux142uxf3w-dla-kilku-naukowcuxf3w}{%
\subsubsection{Zestawienie ilości opublikowanych artykułów dla kilku
naukowców}\label{zestawienie-iloux15bci-opublikowanych-artykuux142uxf3w-dla-kilku-naukowcuxf3w}}

Do analizy wybrano cztery profile naukowców, różniących się stażem pracy
na Uczelni, żeby zobrazować intensywność i dynamikę ich potencjału
publikacyjnego.
...
\NormalTok{Kulczycki }\OtherTok{\textless{}{-}} \StringTok{"RNDE9{-}wAAAAJ"}  
\NormalTok{Sacala }\OtherTok{\textless{}{-}} \StringTok{"jkj3pCQAAAAJ\&hl"} 
\NormalTok{Samoraj }\OtherTok{\textless{}{-}} \StringTok{"um0TaCEAAAAJ"} 
...
\NormalTok{Samoraj.num }\OtherTok{\textless{}{-}} \FunctionTok{get\_num\_articles}\NormalTok{(Samoraj)}
...
\NormalTok{                              Samoraj.num, }
\NormalTok{                              Pietr.num),}
                  \AttributeTok{Osoba=} \FunctionTok{c}\NormalTok{(}\StringTok{"Kulczycki"}\NormalTok{, }\StringTok{"Sacala"}\NormalTok{, }\StringTok{"Samoraj"}\NormalTok{, }\StringTok{"Pietr"}\NormalTok{))}

\CommentTok{\# wizualizacja ilości cytowań}
\FunctionTok{ggplot}\NormalTok{(num, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Osoba, }\AttributeTok{y=}\NormalTok{Ilosc, }\AttributeTok{fill =}\NormalTok{ Osoba)) }\SpecialCharTok{+} 
\FunctionTok{geom\_col}\NormalTok{()}\SpecialCharTok{+}
\FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+} 
\FunctionTok{scale\_fill\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"BrBG"}\NormalTok{)}\SpecialCharTok{+}
\FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{label=}\NormalTok{Ilosc),}\AttributeTok{position=}\FunctionTok{position\_stack}\NormalTok{(}\AttributeTok{vjust=}\FloatTok{1.1}\NormalTok{),}\AttributeTok{size=}\DecValTok{6}\NormalTok{)}\SpecialCharTok{+}
...
\includegraphics{Rysunki/figures/ilosc_publikacji-1.pdf}

Współprace publikacyjną dla wybranego naukowca przedstawiono z
wykorzystaniem biblioteki
\href{https://github.com/pablobarbera/scholarnetwork}{scholarnetwork}.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(igraph)}
\FunctionTok{library}\NormalTok{(scholarnetwork)}
\FunctionTok{library}\NormalTok{(ggplot2)}
\NormalTok{d }\OtherTok{\textless{}{-}} \FunctionTok{extractNetwork}\NormalTok{(}\AttributeTok{id=}\StringTok{"RNDE9{-}wAAAAJ"}\NormalTok{, }\AttributeTok{n=}\DecValTok{2}\NormalTok{)}
...
\begin{verbatim}
## List of 2
##  $ nodes:'data.frame':   53 obs. of  3 variables:
##   ..$ label : chr [1:53] "A Bartmañski" "A Bartmański" "A Demczuk" "A Jachymczak" ...
##   ..$ degree: num [1:53] 0.667 0.667 5.45 2.667 2.833 ...
##   ..$ group : num [1:53] 7 12 2 8 1 1 5 6 1 7 ...
##  $ edges:'data.frame':   143 obs. of  3 variables:
##   ..$ node1 : chr [1:143] "B Karoñ" "G Kulczycki" "B Karoń" "G Kulczycki" ...
##   ..$ node2 : chr [1:143] "A Bartmañski" "A Bartmañski" "A Bartmański" "A Bartmański" ...
##   ..$ weight: num [1:143] 0.333 0.333 0.333 0.333 0.45 ...
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plotNetwork}\NormalTok{(d}\SpecialCharTok{$}\NormalTok{nodes, d}\SpecialCharTok{$}\NormalTok{edges, }\AttributeTok{file=}\StringTok{"network.html"}\NormalTok{)}
\CommentTok{\# cleaning network data}
\NormalTok{network }\OtherTok{\textless{}{-}} \FunctionTok{graph\_from\_data\_frame}\NormalTok{(d}\SpecialCharTok{$}\NormalTok{edges, }\AttributeTok{directed=}\ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
\NormalTok{l }\OtherTok{\textless{}{-}} \FunctionTok{layout.fruchterman.reingold}\NormalTok{(network, }\AttributeTok{niter=}\DecValTok{50}\NormalTok{) }\CommentTok{\# layout}
\NormalTok{fc }\OtherTok{\textless{}{-}} \FunctionTok{walktrap.community}\NormalTok{(network) }\CommentTok{\# community detection}
\CommentTok{\# node locations}
\NormalTok{nodes }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(l); }\FunctionTok{names}\NormalTok{(nodes) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\StringTok{"y"}\NormalTok{)}
\NormalTok{nodes}\SpecialCharTok{$}\NormalTok{cluster }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(fc}\SpecialCharTok{$}\NormalTok{membership)}
\NormalTok{nodes}\SpecialCharTok{$}\NormalTok{label }\OtherTok{\textless{}{-}}\NormalTok{ fc}\SpecialCharTok{$}\NormalTok{names}
\NormalTok{nodes}\SpecialCharTok{$}\NormalTok{degree }\OtherTok{\textless{}{-}} \FunctionTok{degree}\NormalTok{(network)}
\CommentTok{\# edge locations}
\NormalTok{edgelist }\OtherTok{\textless{}{-}} \FunctionTok{get.edgelist}\NormalTok{(network, }\AttributeTok{names=}\ConstantTok{FALSE}\NormalTok{)}
\NormalTok{edges }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(nodes[edgelist[,}\DecValTok{1}\NormalTok{],}\FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\StringTok{"y"}\NormalTok{)], nodes[edgelist[,}\DecValTok{2}\NormalTok{],}\FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{, }\StringTok{"y"}\NormalTok{)])}
\FunctionTok{names}\NormalTok{(edges) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"x1"}\NormalTok{, }\StringTok{"y1"}\NormalTok{, }\StringTok{"x2"}\NormalTok{, }\StringTok{"y2"}\NormalTok{)}
\CommentTok{\# and now visualizing it...}
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(nodes, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x, }\AttributeTok{y=}\NormalTok{y, }\AttributeTok{color=}\NormalTok{cluster, }\AttributeTok{label=}\NormalTok{label, }\AttributeTok{size=}\NormalTok{degree))}
\NormalTok{pq }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{+} \FunctionTok{geom\_text}\NormalTok{(}\AttributeTok{color=}\StringTok{"black"}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{label=}\NormalTok{label, }\AttributeTok{size=}\NormalTok{degree),}
                    \AttributeTok{show\_guide=}\ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+}
  \CommentTok{\# nodes}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color=}\StringTok{"grey20"}\NormalTok{, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{fill=}\NormalTok{cluster),}
             \AttributeTok{shape=}\DecValTok{21}\NormalTok{, }\AttributeTok{show\_guide=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{alpha=}\DecValTok{1}\SpecialCharTok{/}\DecValTok{2}\NormalTok{) }\SpecialCharTok{+}
  \CommentTok{\# edges}
  \FunctionTok{geom\_segment}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x1, }\AttributeTok{y=}\NormalTok{y1, }\AttributeTok{xend=}\NormalTok{x2, }\AttributeTok{yend=}\NormalTok{y2, }\AttributeTok{label=}\ConstantTok{NA}\NormalTok{),}
    \AttributeTok{data=}\NormalTok{edges, }\AttributeTok{size=}\FloatTok{0.5}\NormalTok{, }\AttributeTok{color=}\StringTok{"grey20"}\NormalTok{, }\AttributeTok{alpha=}\FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
  \DocumentationTok{\#\# note that here I add a border to the points}
  \FunctionTok{scale\_fill\_discrete}\NormalTok{(}\AttributeTok{labels=}\NormalTok{labels) }\SpecialCharTok{+}
  \FunctionTok{scale\_size\_continuous}\NormalTok{(}\AttributeTok{range =} \FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{6}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Sieć współautorstwa Grzegorza Kulczyckiego"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}
    \AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size =} \DecValTok{14}\NormalTok{, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{face =} \StringTok{"bold"}\NormalTok{, }\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{),}
    ...
    \AttributeTok{axis.line =} \FunctionTok{element\_blank}\NormalTok{(), }\AttributeTok{axis.text =} \FunctionTok{element\_blank}\NormalTok{(),}
    \AttributeTok{axis.ticks =} \FunctionTok{element\_blank}\NormalTok{(),}
    \AttributeTok{axis.title =} \FunctionTok{element\_blank}\NormalTok{(), }\AttributeTok{panel.border =} \FunctionTok{element\_blank}\NormalTok{(),}
    \AttributeTok{panel.grid.major =} \FunctionTok{element\_blank}\NormalTok{(),}
    \AttributeTok{panel.grid.minor =} \FunctionTok{element\_blank}\NormalTok{(),}
    \AttributeTok{legend.background =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{colour =}\NormalTok{ F, }\AttributeTok{fill =} \StringTok{"black"}\NormalTok{),}
    \AttributeTok{legend.key =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{fill =} \StringTok{"black"}\NormalTok{, }\AttributeTok{colour =}\NormalTok{ F),}
...
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{guides}\NormalTok{(}\AttributeTok{fill =} \FunctionTok{guide\_legend}\NormalTok{(}\AttributeTok{override.aes =} \FunctionTok{list}\NormalTok{(}\AttributeTok{size=}\DecValTok{4}\NormalTok{)))}
\NormalTok{pq}
\end{Highlighting}
\end{Shaded}

\includegraphics{Rysunki/figures/wspolpraca-1.pdf}

\hypertarget{poruxf3wnanie-sumy-cytowaux144-dla-publikacji-napisanych-przez-naukowcuxf3w-w-kolejnych-latach-ich-pracy}{%
\subsubsection{Porównanie sumy cytowań dla publikacji napisanych przez
naukowców w kolejnych latach ich
pracy}\label{poruxf3wnanie-sumy-cytowaux144-dla-publikacji-napisanych-przez-naukowcuxf3w-w-kolejnych-latach-ich-pracy}}

Dla tych samych profili naukowców przeprowadzono także analizę cytowań
ich publikacji. Wyznaczone krzywe na podstawie ilości cytowań wskazują
na różnicę w ilości cytowań w latach dla tych naukowców.
...
\NormalTok{ids }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"RNDE9{-}wAAAAJ\&hl"}\NormalTok{, }\StringTok{"jkj3pCQAAAAJ\&hl"}\NormalTok{,}
         \StringTok{"L6MYKCQAAAAJ\&hl"}\NormalTok{,}\StringTok{"um0TaCEAAAAJ"}\NormalTok{)}
\CommentTok{\#utworzenie ramki danych}
...
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{year, }\AttributeTok{y=}\NormalTok{total, }\AttributeTok{group =}\NormalTok{ name)) }\SpecialCharTok{+}
  ...
  \FunctionTok{scale\_fill\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"BrBG"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{label=}\NormalTok{total), }\AttributeTok{size =} \DecValTok{4}\NormalTok{, }\AttributeTok{check\_overlap =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{+}
  ...
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{14}\NormalTok{, }\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{),}
   ...
   \AttributeTok{legend.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour=}\StringTok{"black"}\NormalTok{, }\AttributeTok{size=}\DecValTok{8}\NormalTok{, }\AttributeTok{face=}\StringTok{"bold"}\NormalTok{),}
   \AttributeTok{legend.text =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour=}\StringTok{"black"}\NormalTok{, }\AttributeTok{size=}\DecValTok{8}\NormalTok{,}\AttributeTok{face=}\StringTok{"bold"}\NormalTok{),}
   \AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{face=}\StringTok{"bold"}\NormalTok{, }\AttributeTok{color=}\StringTok{"\#993333"}\NormalTok{, }\AttributeTok{size=}\DecValTok{14}\NormalTok{),}
...
\includegraphics{Rysunki/figures/porownanie-1.pdf}

\hypertarget{dynamika-rozwoju-publikacyjnego-wybranych-naukowcuxf3w-na-podstawie-iloux15bci-skumulowanych-cytowaux144-w-zaleznoux15bci-od-dux142ugoux15bci-staux17cu-pracy.}{%
\subsubsection{Dynamika rozwoju publikacyjnego wybranych naukowców na
podstawie ilości skumulowanych cytowań w zalezności od długości stażu
pracy.}\label{dynamika-rozwoju-publikacyjnego-wybranych-naukowcuxf3w-na-podstawie-iloux15bci-skumulowanych-cytowaux144-w-zaleznoux15bci-od-dux142ugoux15bci-staux17cu-pracy.}}

Na podstawie otrzymanego wykresu, uwidacznia się inna dynamika cytowań
dla młodych naukowców w porównaniu z pracownikami z dłuższym stażem.
Wynikać to może z obecnego systemu ewaluacji, w którym młodzi naukowcy
obecnie publikują prawie wyłącznie w języku angielskim w indeksowanych
czasopismach dostępnych dla szerszego grona społeczności akademickiej.
...
\NormalTok{ids }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"RNDE9{-}wAAAAJ\&hl"}\NormalTok{, }\StringTok{"jkj3pCQAAAAJ\&hl"}\NormalTok{,}\StringTok{"L6MYKCQAAAAJ\&hl"}\NormalTok{ , }\StringTok{"um0TaCEAAAAJ"}\NormalTok{)}
\NormalTok{df\_3 }\OtherTok{\textless{}{-}} \FunctionTok{compare\_scholar\_careers}\NormalTok{(ids)}

\DocumentationTok{\#\# Add cumulative citation}
\NormalTok{df\_3 }\OtherTok{\textless{}{-}} \FunctionTok{ddply}\NormalTok{(}\AttributeTok{.data =}\NormalTok{ df\_3,}
            \AttributeTok{.variables =} \FunctionTok{c}\NormalTok{(}\StringTok{"id"}\NormalTok{),}
            \AttributeTok{.fun =}\NormalTok{ transform,}
            \AttributeTok{cumulative\_cites =} \FunctionTok{cumsum}\NormalTok{(cites))}
\DocumentationTok{\#\# Plot}
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(df\_3, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ career\_year, }\AttributeTok{y =}\NormalTok{ cumulative\_cites)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{colour =}\NormalTok{ name)) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"BrBG"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{label=}\NormalTok{cumulative\_cites), }\AttributeTok{size=}\DecValTok{4}\NormalTok{,}\AttributeTok{check\_overlap =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y=}\StringTok{"Skumulowane cytowania"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Lata pracy"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{( }\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{14}\NormalTok{, }\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{),}
         \AttributeTok{legend.position=}\StringTok{"top"}\NormalTok{,}
         \AttributeTok{legend.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{colour=}\StringTok{"black"}\NormalTok{, }\AttributeTok{size=}\DecValTok{8}\NormalTok{, }\AttributeTok{face=}\StringTok{"bold"}\NormalTok{),}
...
\includegraphics{Rysunki/figures/dynamika-1.pdf}

\hypertarget{metoda-web-scraping-gs}{%
\subsubsection{Metoda web scraping (GS)}\label{metoda-web-scraping-gs}}

Metody te nie są dozwolone na tej bazie danych, ale dla celów
dydaktycznych w projekcie wykorzystano bibliotekę
\href{https://pypi.org/project/beautifulsoup4/}{BeautifulSoup} do
uzyskania tytułów publikacji i linków dla profilu własnego (id =
RNDE9-wAAAAJ) w GS. Moduł BeautifulSoup wykorzystuje się do parsowania i
przeszukiwania dokumentów HTML.
...
\NormalTok{pd.set\_option(}\StringTok{\textquotesingle{}display.max\_colwidth\textquotesingle{}}\NormalTok{, }\DecValTok{65}\NormalTok{)}
...
\NormalTok{headers }\OperatorTok{=}\NormalTok{ \{}
    ...
    \StringTok{\textquotesingle{}User{-}Agent\textquotesingle{}}\NormalTok{: (}\StringTok{\textquotesingle{}Mozilla/5.0 (Windows NT 10.0; Win64; x64) \textquotesingle{}}
                   \StringTok{\textquotesingle{}AppleWebKit/537.36 (KHTML, like Gecko) \textquotesingle{}}
                   \StringTok{\textquotesingle{}Chrome/105.0.0.0 Safari/537.36\textquotesingle{}}\NormalTok{)\}}
...
\NormalTok{    url }\OperatorTok{=}\NormalTok{ (}
    \SpecialStringTok{f\textquotesingle{}https://scholar.google.com/citations?hl=en\&user=RNDE9{-}wAAAAJ\&\textquotesingle{}}
    \SpecialStringTok{f\textquotesingle{}cstart=}\SpecialCharTok{\{}\NormalTok{x}\SpecialCharTok{\}}\SpecialStringTok{\&pagesize=100\textquotesingle{}}\NormalTok{)}
...
\NormalTok{    works }\OperatorTok{=}\NormalTok{ [(x.get\_text(), }\StringTok{\textquotesingle{}https://scholar.google.com\textquotesingle{}} \OperatorTok{+}\NormalTok{ x.get(}\StringTok{\textquotesingle{}href\textquotesingle{}}\NormalTok{))}
    ...
    \ControlFlowTok{if} \KeywordTok{not}\NormalTok{ works:  }
...
\BuiltInTok{print}\NormalTok{(limited\_df)}
\end{Highlighting}
\end{Shaded}
...
## 3                  Content of selenium in arable soils near Wroclaw   
## 4  Sulfur application alleviates chromium stress in maize and wheat   
## 5  Wpływ terminu siewu przewódkowych odmian pszenicy uprawianych...   
## 6  Wplyw nawozenia siarka elementarna na zawartosc mikroelemento...   
## 7  Towards circular economy: Sustainable soil additives from nat...   
## 8  Zawartosc mikroelementow w ziarnie i slomie wybranych odmian ...   
## 9  Wpływ nawożenia siarką elementarną na plon i skład chemiczny ...   
## 
##                                                                Link  
...
Wynik wyszukiwania zapisywany jest do pliku csv (rys. \ref{plik_csv}),
dane z tego pliku można wykorzystać do dalszych analiz i wizualizacji.
...
Z otrzymanego pliku csv wyodrębniono tytuły publikacji jako plik txt w
celu wykonania chmury wyrazów.

\hypertarget{utworzenie-oddzielnych-plikuxf3w-z-tytuux142ami-w-jux119zyku-angielskim-i-polskim}{%
\subsubsection{Utworzenie oddzielnych plików z tytułami w języku
angielskim i
polskim}\label{utworzenie-oddzielnych-plikuxf3w-z-tytuux142ami-w-jux119zyku-angielskim-i-polskim}}

Ponieważ w pliku znajdują się tytuły w języku angielskim i polskim,
wykorzystano bibliotekę
\href{https://pypi.org/project/langdetect/}{langdetect 1.0.9} do
stworzenia oddzielnych plików z tytułami w języku angielskim i polskim.

\begin{Shaded}
\begin{Highlighting}[]

\ImportTok{from}\NormalTok{ langdetect }\ImportTok{import}\NormalTok{ detect}
\ImportTok{import}\NormalTok{ pandas }\ImportTok{as}\NormalTok{ pd}

\CommentTok{\# Odczytaj plik i przeczytaj tytuły artykułów}
\ControlFlowTok{with} \BuiltInTok{open}\NormalTok{(}\StringTok{\textquotesingle{}siarka.txt\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}r\textquotesingle{}}\NormalTok{, encoding}\OperatorTok{=}\StringTok{\textquotesingle{}utf{-}8\textquotesingle{}}\NormalTok{) }\ImportTok{as} \BuiltInTok{file}\NormalTok{:}
\NormalTok{    article\_titles }\OperatorTok{=} \BuiltInTok{file}\NormalTok{.readlines()}

\CommentTok{\# Inicjalizacja list na tytuły po angielsku i po polsku}
\NormalTok{english\_titles }\OperatorTok{=}\NormalTok{ []}
\NormalTok{polish\_titles }\OperatorTok{=}\NormalTok{ []}

\CommentTok{\# Podział tytułów na dwa zestawy bazując na wykrytym języku}
\ControlFlowTok{for}\NormalTok{ title }\KeywordTok{in}\NormalTok{ article\_titles:}
    \ControlFlowTok{if}\NormalTok{ detect(title) }\OperatorTok{==} \StringTok{\textquotesingle{}en\textquotesingle{}}\NormalTok{:}
\NormalTok{        english\_titles.append(title)}
    \ControlFlowTok{elif}\NormalTok{ detect(title) }\OperatorTok{==} \StringTok{\textquotesingle{}pl\textquotesingle{}}\NormalTok{:}
\NormalTok{        polish\_titles.append(title)}

\CommentTok{\# Zapisz tytuły artykułów po angielsku do pliku}
\ControlFlowTok{with} \BuiltInTok{open}\NormalTok{(}\StringTok{\textquotesingle{}english\_titles.txt\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}w\textquotesingle{}}\NormalTok{, encoding}\OperatorTok{=}\StringTok{\textquotesingle{}utf{-}8\textquotesingle{}}\NormalTok{) }\ImportTok{as} \BuiltInTok{file}\NormalTok{:}
    \BuiltInTok{file}\NormalTok{.writelines(english\_titles)}

\CommentTok{\# Zapisz tytuły artykułów po polsku do pliku}
\ControlFlowTok{with} \BuiltInTok{open}\NormalTok{(}\StringTok{\textquotesingle{}polish\_titles.txt\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}w\textquotesingle{}}\NormalTok{, encoding}\OperatorTok{=}\StringTok{\textquotesingle{}utf{-}8\textquotesingle{}}\NormalTok{) }\ImportTok{as} \BuiltInTok{file}\NormalTok{:}
    \BuiltInTok{file}\NormalTok{.writelines(polish\_titles)}
\end{Highlighting}
\end{Shaded}

Pliki te wykorzystano do stworzenia chmur wyrazów w języku angielskim i
polskim za pomocą biblioteki
\href{https://cran.r-project.org/web/packages/wordcloud/index.html}{wordcloud}.

\hypertarget{utworzenie-chmury-wyrazuxf3w-w-jux119zyku-angielskim}{%
\subsubsection{Utworzenie chmury wyrazów w języku
angielskim:}\label{utworzenie-chmury-wyrazuxf3w-w-jux119zyku-angielskim}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(tm)}
\CommentTok{\#library(SnowballC)}
\FunctionTok{library}\NormalTok{(wordcloud)}
\FunctionTok{library}\NormalTok{(RColorBrewer)}

\NormalTok{filePath }\OtherTok{\textless{}{-}} \StringTok{"english\_titles.txt"}
\NormalTok{text }\OtherTok{\textless{}{-}} \FunctionTok{readLines}\NormalTok{(filePath)}
...
\NormalTok{docs }\OtherTok{\textless{}{-}} \FunctionTok{tm\_map}\NormalTok{(docs, toSpace, }\StringTok{"@"}\NormalTok{)}
\NormalTok{docs }\OtherTok{\textless{}{-}} \FunctionTok{tm\_map}\NormalTok{(docs, toSpace, }\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{|"}\NormalTok{)}
...
\NormalTok{docs }\OtherTok{\textless{}{-}} \FunctionTok{tm\_map}\NormalTok{(docs, removeWords, }\FunctionTok{c}\NormalTok{(}\StringTok{"blabla1"}\NormalTok{, }\StringTok{"blabla2"}\NormalTok{)) }
...
\FunctionTok{head}\NormalTok{(d, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{wordcloud}\NormalTok{(}\AttributeTok{words =}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{word, }\AttributeTok{freq =}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{freq, }\AttributeTok{min.freq =} \DecValTok{1}\NormalTok{,}
...
\includegraphics{Rysunki/figures/wordcloud_en-1.pdf}

\hypertarget{utworzenie-chmury-wyrazuxf3w-w-jux119zyku-polskim}{%
\subsubsection{Utworzenie chmury wyrazów w języku
polskim:}\label{utworzenie-chmury-wyrazuxf3w-w-jux119zyku-polskim}}
...
\NormalTok{filePath }\OtherTok{\textless{}{-}} \StringTok{"polish\_titles.txt"}
\NormalTok{text }\OtherTok{\textless{}{-}} \FunctionTok{readLines}\NormalTok{(filePath)}
\NormalTok{docs }\OtherTok{\textless{}{-}} \FunctionTok{Corpus}\NormalTok{(}\FunctionTok{VectorSource}\NormalTok{(text))}
\NormalTok{toSpace }\OtherTok{\textless{}{-}} \FunctionTok{content\_transformer}\NormalTok{(}\ControlFlowTok{function}\NormalTok{ (x , pattern ) }\FunctionTok{gsub}\NormalTok{(pattern, }\StringTok{" "}\NormalTok{, x))}
\NormalTok{docs }\OtherTok{\textless{}{-}} \FunctionTok{tm\_map}\NormalTok{(docs, toSpace, }\StringTok{"/"}\NormalTok{)}
...
## glebach               glebach    6
## mikroelementow mikroelementow    5
## roslinach           roslinach    5
## nawozenia           nawozenia    4
## wplyw                   wplyw    4
## odmian                 odmian    4
## ozimej                 ozimej    4
## pszenicy             pszenicy    4
## wybranych           wybranych    4
\end{verbatim}
...
\includegraphics{Rysunki/figures/wordcloud_pl-1.pdf}
...
W przypadku bazy Semantic Scholar przy przeszukiwaniu istnieje możliwość
korzystania z interfejsu API REST (ang. Representational State
Transfer). Kluczową cechą API REST jest wykorzystanie protokołu HTTP
(Hypertext Transfer Protocol) do komunikacji między klientem a serwerem
oraz stosowanie standardowych metod HTTP, takich jak GET, POST, PUT,
DELETE, itp., do manipulowania zasobami. Ogólnie jest to technika, która
pozwala na automatyczny dostęp i pobieranie informacji między różnymi
maszynami.

Interfejs API umożliwia wyszukiwanie i eksplorowanie danych publikacji
naukowych dotyczących autorów, artykułów, czy cytowań.
\href{https://www.semanticscholar.org/product/api}{Semantic Scholar API}
umożliwia skorzystanie z następujących usług :

\begin{itemize}
\item
  \textbf{Academic Graph:} Zapewnia dane o autorach, artykułach,
  cytowaniach, miejscach, osadzeniach SPECTER2 i innych, które
  umożliwiają bezpośrednie połączenie z odpowiednią stroną na
  semanticscholar.org, aby uzyskać więcej informacji.
\item
  \textbf{Rekomendacje:} Zawiera rekomendowane artykuły podobne do
  danego artykułu.
\item
  \textbf{Datasets:} Udostępnia linki do pobrania zbiorów danych na
  wykresie akademickim.
\item
  \textbf{Conference Peer Review:} Zapewnia narzędzia pomagające
  organizatorom konferencji z problemem przypisywania recenzentów do
  zgłoszeń konferencyjnych. Obejmuje wykrywanie konfliktu interesów w
  oparciu o relacje między współautorami oraz obliczanie wyniku
  dopasowania między recenzentem a tematem zgłoszenia w oparciu o
  historię publikacji recenzenta.
\end{itemize}

Użytkownik bazy Semantic Scholar możne złożyć wniosek o przyznanie
klucza API, dzięki czemu uzyskuje następujące parametry połączenia:

\begin{itemize}
\tightlist
\item
  Limit szybkości: - 1 żądanie na sekundę dla następujących punktów
  końcowych:
\end{itemize}
...
Dostęp do dużych ilości danych za pośrednictwem interfejsów API jest
istotny ze względu na przeprowadzenie lepszych i głębszych analiz, które
mogą wydobyć ukrytą wiedzę i znaleźć nowe wzorce zachowań
(\protect\hyperlink{ref-velez-estevez2023}{Velez-Estevez i in., 2023})

Poniżej przedstawiono możliwości przeszukiwanie bazy danych Semantic
Scholar:

\hypertarget{wyszukanie-nazwisk-autoruxf3w-publikacji-poprzez-id-ich-profili-z-wykorzystaniem-biblioteki-semanticscholar-0.7.0.}{%
\subsubsection{\texorpdfstring{Wyszukanie nazwisk autorów publikacji
poprzez id ich profili z wykorzystaniem biblioteki
\href{https://pypi.org/project/semanticscholar}{semanticscholar
0.7.0}.}{Wyszukanie nazwisk autorów publikacji poprzez id ich profili z wykorzystaniem biblioteki semanticscholar 0.7.0.}}\label{wyszukanie-nazwisk-autoruxf3w-publikacji-poprzez-id-ich-profili-z-wykorzystaniem-biblioteki-semanticscholar-0.7.0.}}

\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{from}\NormalTok{ semanticscholar }\ImportTok{import}\NormalTok{ SemanticScholar}

\NormalTok{sch }\OperatorTok{=}\NormalTok{ SemanticScholar()}
\NormalTok{list\_of\_author\_ids }\OperatorTok{=}\NormalTok{ [}\StringTok{\textquotesingle{}113275711\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}12961311\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}87266064\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}113633308\textquotesingle{}}\NormalTok{]}
\NormalTok{results }\OperatorTok{=}\NormalTok{ sch.get\_authors(list\_of\_author\_ids)}
\BuiltInTok{print}\NormalTok{(}\StringTok{"Użytkownicy bazy Semantic Scholar:"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Użytkownicy bazy Semantic Scholar:
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{ item }\KeywordTok{in}\NormalTok{ results:}
    \BuiltInTok{print}\NormalTok{(item.name)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{przeszukiwanie-bazy-poprzez-frazux119-sux142uxf3w-z-wykorzystaniem-biblioteki-semanticscholar-0.7.0.}{%
\subsubsection{\texorpdfstring{Przeszukiwanie bazy poprzez frazę słów z
wykorzystaniem biblioteki
\href{https://pypi.org/project/semanticscholar}{semanticscholar
0.7.0}.}{Przeszukiwanie bazy poprzez frazę słów z wykorzystaniem biblioteki semanticscholar 0.7.0.}}\label{przeszukiwanie-bazy-poprzez-frazux119-sux142uxf3w-z-wykorzystaniem-biblioteki-semanticscholar-0.7.0.}}
...
\NormalTok{sch }\OperatorTok{=}\NormalTok{ SemanticScholar()}
\NormalTok{results }\OperatorTok{=}\NormalTok{ sch.search\_paper(}\StringTok{\textquotesingle{}elemental sulphur fertilization\textquotesingle{}}\NormalTok{)}
\NormalTok{counter }\OperatorTok{=} \DecValTok{1}
\BuiltInTok{print}\NormalTok{(}\StringTok{"Wyniki wyszukiwania 10 pierwszych rekordów: "}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Wyniki wyszukiwania 10 pierwszych rekordów:
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{for}\NormalTok{ index, item }\KeywordTok{in} \BuiltInTok{enumerate}\NormalTok{(results):}
    \CommentTok{\# Print the number and title of the paper}
    \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{index}\OperatorTok{+}\DecValTok{1}\SpecialCharTok{\}}\SpecialStringTok{. }\SpecialCharTok{\{}\NormalTok{item}\SpecialCharTok{.}\NormalTok{title}\SpecialCharTok{\}}\SpecialStringTok{"}\NormalTok{)}
\NormalTok{    counter }\OperatorTok{+=} \DecValTok{1}
    \ControlFlowTok{if}\NormalTok{ counter }\OperatorTok{\textgreater{}} \DecValTok{10}\NormalTok{:}
        \ControlFlowTok{break}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## 1. Improving nutritional status, yield and fruit quality of Barhi Date palm cultivar by using different levels of elemental sulphur fertilization under Soba Conditions
## 2. Effect of combined fertilization with rock phosphate and elemental sulphur on yield and nutrient uptake of soybean
## 3. Sulphur fertilization on biochemical constituents of cabbage (Brassica oleracea var. capitata. L) in non-calcareous soil of Coimbatore district, Tamil Nadu
## 4. THE EFFECT OF ELEMENTAL SULFUR FERTILIZATION ON GREEN BEANS ( Phaseolus Vulgaris L.) GROWN IN CALCAREOUS SOIL
## 5. Effect of Sulphur Fertilization on Amino Acid and Fraction Composition of Protein of White Mustard Seeds
## 6. Influence of sulphur fertilization on nutrient uptake of onion (Allium cepa L.)
## 7. EFFECT OF SULPHUR FERTILIZATION ON GROWTH, YIELD AND NUTRIENT UPTAKE OF SUNFLOWER IN NORTH CAUVERY DELTAIC REGION -
## 8. EFFECT OF SULPHUR FERTILIZATION ON GROWTH , YIELD AND QUALITY OF SESAME ( SESAMUM INDICUM L . ) IN MID CENTRAL ZONE OF ODISHA
## 9. Influence of planting dates and sulphur fertilization on physical and chemical traits of onion cv. PUSA RED.
## 10. DOES THE SULPHUR FERTILIZATION MODIFY MAGNESIUM AND CALCIUM CONTENT IN POTATO TUBERS (Solanum tuberosum L.)
\end{verbatim}

\hypertarget{przeszukiwanie-bazy-danych-z-wykorzystaniem-chatopenai-z-pomocux105-semantic-scholar-api-tool}{%
\subsubsection{\texorpdfstring{Przeszukiwanie bazy danych z
wykorzystaniem \href{https://platform.openai.com/apps}{ChatOpenAI} z
pomocą
\href{https://python.langchain.com/docs/integrations/tools/semanticscholar}{Semantic
Scholar API
Tool}}{Przeszukiwanie bazy danych z wykorzystaniem ChatOpenAI z pomocą Semantic Scholar API Tool}}\label{przeszukiwanie-bazy-danych-z-wykorzystaniem-chatopenai-z-pomocux105-semantic-scholar-api-tool}}

Na rysunku \ref{langchain_cod} przedstawiono skrypt wykorzystujący
ChatGPT do przeszukiwania i uzyskiwania odpowiedzi na zadawane pytania z
bazy Semantic Scholar. W skrypcie zastosowano własny klucz API
wygenerowany na stronie
\href{https://platform.openai.com/api-keys}{OpenAI}.

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{Rysunki/langchain_cod.png}
\caption{Skrypt Semantic Scholar API Tool \label{langchain_cod}}
\end{figure}

Przykład uzyskanych wyników dla zadawanych pytań poprzez skrypt Semantic
Scholar API Tool rys. \ref{langchain_output}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{Rysunki/langchain_output.png}
\caption{Wynik zastosowania skryptu wykorzystujący ChatGPT
\label{langchain_output}}
\end{figure}
...
\textbf{Na podstawie przeprowadzonych analiz wyciągnięto następujące
wnioski:}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Narzędzia data science w znacząco usprawniają przegląd literatury w
  obu analizowanych bazach indeksujących w porównaniu do tradycyjnych
  metod ich przeszukiwania.
\item
  Metody data science szczególnie pomocne są przy analizowaniu danych z
  tych baz w szerszej skali (np. analiza porównawcza bibliometryczna
  dorobku kilkunastu użytkowników lub porównanie siły oddziaływania
  czasopism z określonego obszaru badawczego).
\item
  Wykorzystania kilku narzędzi data science (np. języki Python, R,
  ChatGPT) do przeglądu bibliometrycznego umożliwia uzyskanie
  niestandardowych efektów takiej pracy.
\item
  Intensywny rozwój metod data science będzie się przyczyniać do
  powstawania coraz bardziej efektywnych metod wykonywania przeglądów
  bibliometrycznych.
\end{enumerate}
...
\leavevmode\vadjust pre{\hypertarget{ref-velez-estevez2023}{}}%
Velez-Estevez, A., I.J. Perez, P. García-Sánchez, J.A. Moral-Munoz, i
M.J. Cobo. 2023. New trends in bibliometric APIs: A comparative
analysis. Information Processing \& Management 60(4): 103385. doi:
\href{https://doi.org/10.1016/j.ipm.2023.103385}{10.1016/j.ipm.2023.103385}.
